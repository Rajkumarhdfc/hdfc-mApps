 ...
 */
var LacRemarksPage = /** @class */ (function () {
    function LacRemarksPage(navCtrl, navParams, dbProvider) {
    ...
    LacRemarksPage.prototype.GetlacRemarks = function () {
        var _this = this;
    ...
    LacRemarksPage.prototype.ionViewDidLoad = function () {
        this.GetlacRemarks();
        console.log('ionViewDidLoad LacRemarksPage');
    };
    LacRemarksPage = __decorate([
        IonicPage(),
        Component({
    ...
    return LacRemarksPage;
}());
export { LacRemarksPage };
//# sourceMappingURL=lac-remarks.js.map