 ...
 */
var LacdIPage = /** @class */ (function () {
    function LacdIPage(navCtrl, navParams, dbProvider) {
    ...
    LacdIPage.prototype.GetlacdDetails = function () {
        var _this = this;
        this.dbProvider.GetLacDinfo(this.LacNo)
            .then(function (result) {
            console.log(_this.LacNo);
            _this.lacddetails = result;
            console.log(_this.lacddetails);
        }, function (error) {
            console.log("ERROR: ", error);
        });
    };
    LacdIPage.prototype.ionViewDidLoad = function () {
        this.GetlacdDetails();
        console.log('ionViewDidLoad LacdIPage');
    };
    LacdIPage = __decorate([
        IonicPage(),
        Component({
...
export { LacdIPage };
//# sourceMappingURL=lacd-i.js.map